      ...
      <Container>
        ...
        <section className="mb-5">
          ...
          <ul className="pl-3">
            <li>
              <a
                href="http://dashboards.webkom.co/react-next/airframe/layouts/navbar"
                className="text-primary"
              >
                Navbar
              </a>
            ...
            <li>
              <a
                href="http://dashboards.webkom.co/react-next/airframe/layouts/sidebar"
                className="text-primary"
              >
                Sidebar
              </a>
            ...
            <li>
              <a
                href="http://dashboards.webkom.co/react-next/airframe/layouts/sidebar-with-navbar"
                className="text-primary"
              >
                Sidebar with Navbar
              </a>
        ...
        <section className="mb-5">
          ...
          <ul className="pl-3">
            <li>
              <a
                href="https://webkom.gitbook.io/spin/v/airframe/airframe-next.js/documentation-next.js"
                className="text-primary"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li>
              <a
                href="https://webkom.gitbook.io/spin/v/airframe/airframe-next.js/credits-next.js"
                className="text-primary"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li>
              <a
                href="https://webkom.gitbook.io/spin/v/airframe/airframe-next.js/roadmap-react"
                className="text-primary"
                target="_blank"
                rel="noopener noreferrer"
              >
