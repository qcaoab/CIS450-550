...
const _BookCarousel = (props) => {
  ...
  var data = Object.values(props.data.discover_books);
  var slide_data = [];
  while (data.length) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Row style={{ height: "40%" }}>
              <BookCarouselRow data={top} />
            </Row>
            <Row style={{ height: "15%" }}></Row>
            <Row style={{ height: "40%" }}>
              <BookCarouselRow data={bot} />
            </Row>
          </div>
        </div>
      </CarouselItem>
...
export const BookCarousel = connect(
  mapStateToProps,
  null
)(_BookCarousel);
